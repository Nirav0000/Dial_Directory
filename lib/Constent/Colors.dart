...
Color themeDarkColor = const Color(0xFF092635);
Color bottomBG = const Color(0xFF1B4242);
Color moreinfobg = const Color(0xFF5C8374);
Color themeColor = const Color(0xFFC4E5D9);
